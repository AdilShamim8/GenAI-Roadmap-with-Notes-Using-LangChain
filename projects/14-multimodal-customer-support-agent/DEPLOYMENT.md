# Deployment — Multimodal Customer Support Agent
...
```bash
docker build -t 14-multimodal-customer-support-agent .
docker run -p 8000:8000 --env-file .env 14-multimodal-customer-support-agent
```
