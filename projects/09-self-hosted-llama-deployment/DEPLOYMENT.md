# Deployment — Self-Hosted Llama Deployment
...
```bash
docker build -t 09-self-hosted-llama-deployment .
docker run -p 8000:8000 --env-file .env 09-self-hosted-llama-deployment
```
