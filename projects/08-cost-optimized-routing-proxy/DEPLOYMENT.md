# Deployment — Cost-Optimized Routing Proxy
...
```bash
docker build -t 08-cost-optimized-routing-proxy .
docker run -p 8000:8000 --env-file .env 08-cost-optimized-routing-proxy
```
