# Deployment — Computer-Use Data Entry Agent
...
```bash
docker build -t 04-computer-use-data-entry-agent .
docker run -p 8000:8000 --env-file .env 04-computer-use-data-entry-agent
```
