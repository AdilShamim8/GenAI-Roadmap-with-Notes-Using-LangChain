# Deployment — Multi-Agent Research Pipeline
...
```bash
docker build -t 05-multi-agent-research-pipeline .
docker run -p 8000:8000 --env-file .env 05-multi-agent-research-pipeline
```
